...
class Category1Fragment : Fragment() {
    override fun onCreateView(
        ...
        val recipeNames = Array(Recipe.category1.size) { i -> Recipe.category1[i].name }
        val recipeImages = Array(Recipe.category1.size) { i -> Recipe.category1[i].imageResourceId }
        val listener = CaptionedImagesAdapter.Listener { position ->
            ...
            intent.putExtra(RecipeDetailActivity.EXTRA_CATEGORY, "category1")
